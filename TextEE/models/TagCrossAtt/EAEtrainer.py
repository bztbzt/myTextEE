...
from .EAEmodel import TagCrossAttEAEModel
...
class TagCrossAttEAETrainer(BasicTrainer):
    ...
    def load_model(self, checkpoint=None):
        if checkpoint:
            ...
            self.model = TagCrossAttEAEModel(self.config, self.tokenizer, self.type_set)
