...
from .EDmodel import CRFTaggingGNNEDModel
from scorer import compute_ED_scores, print_scores
import ipdb

logger = logging.getLogger(__name__)

EDBatch_fields = ['batch_doc_id', 'batch_wnd_id', 'batch_tokens', 'batch_pieces', 'batch_token_lens', 'batch_token_num', 'batch_text', 'batch_adj','batch_triggers']
...
class CRFTaggingGNNEDTrainer(BasicTrainer):
    ...
    def load_model(self, checkpoint=None):
        if checkpoint:
            ...
            self.model = CRFTaggingGNNEDModel(self.config, self.tokenizer, self.type_set)
